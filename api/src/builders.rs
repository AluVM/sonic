...
use ultrasonic::{
    fe256, AuthToken, CallId, CellAddr, Codex, CodexId, Consensus, ContractId, ContractMeta, ContractName, Genesis,
...
impl Schema {
    pub fn start_issue(
        ...
        IssueBuilder { builder, schema: self, testnet, consensus, codex }
    }
    ...
    pub fn start_issue_mainnet(
        ...
        self.start_issue(method, consensus, false, codex)
    }
    pub fn start_issue_testnet(
        ...
        self.start_issue(method, consensus, true, codex)
    }

    pub fn issue(self, params: IssueParams, codex: Codex) -> Articles {
        let mut builder = self.start_issue(params.core.method, params.consensus, params.testnet, codex);
...
impl IssueBuilder {
    ...
    pub fn finish(self, name: impl Into<TypeName>, timestamp: i64) -> Articles {
        ...
        let issue = Issue { version: default!(), meta, codex: self.codex, genesis };
